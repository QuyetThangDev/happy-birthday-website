...
export const HeroTexts = {
    firstText: "WELCOME TO YOUR SPECIAL DAY",
    secondText: "Ai cũng có một ngày đặc biệt... và cậu cũng vậy!",
    thirdText: "Hãy để mình giúp cậu có một ngày sinh nhật đáng nhớ nhé!",
    firstButton: "Find out more",
    secondButton: "Nhấn vào đây nhé!",
};
export const ServiceTexts = {
    firstText: "GỬI ĐẾN CẬU - NGƯỜI MÀ TỚ LUÔN DÕI THEO",
    secondText: "Hãy mở từng mảnh giấy nhỏ để biết thêm chi tiết nhé!",
    cards: [
        {
            firstText: "GIFT BOX",
            secondText:
                "Ngày nhập học, có một cậu con trai được xếp ngồi cạnh cậu. \
                Cảm giác lúng túng bao trùm lấy cậu ấy. Cậu ta thỉnh thoảng lại lén nhìn \
                sang bên cạnh, có lẽ vì đôi mắt to tròn kia...",
            thirdText: "Thời gian cứ thế trôi qua, cậu con trai ấy"
        },
        {
            firstText: "GIFT BOX",
            secondText:
                "Có bao giờ cậu tự hỏi rằng, mọi người nghĩ gì về mình chưa? \
                Nếu cậu muốn, hãy để mình kể cho nhé, ít nhất đối với mình là vậy...",
        },
        {
            firstText: "GIFT BOX",
            secondText:
